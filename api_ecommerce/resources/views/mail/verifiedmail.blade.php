											...
											<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<!-- <td class="text-12 c-grey l-grey a-right py-20" style="font-size:12px; line-height:16px; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; color:#6e6e6e; text-align:right; padding-top: 20px; padding-bottom: 20px;">
															<webversion class="link c-grey" style="text-decoration:none; color:#6e6e6e;"><span class="link c-grey" style="text-decoration:none; color:#6e6e6e;">Ver este correo en tu navegador</span></webversion>
														</td> -->
													</tr>
												</table>											<!-- END Top -->
																							...
																							<table width="100%" border="0" cellspacing="0" cellpadding="0">
																								...
																								<tr>
																									<td class="text-16 lh-26 a-center pb-25" style="font-size:16px; color:#6e6e6e; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 26px; text-align:center; padding-bottom: 25px;">
																										<multiline>
																											¡Gracias por registrarte! Para completar el proceso, haz clic en el botón de abajo para verificar tu dirección de correo electrónico y activar tu cuenta.
																										</multiline>
																									</td>
																								</tr>
																								<tr>
																												...
																												<td class="btn-16 c-white l-white" bgcolor="#f3189e" style="font-size:16px; line-height:20px; mso-padding-alt:15px 35px; font-family:'PT Sans', Arial, sans-serif; text-align:center; font-weight:bold; text-transform:uppercase; border-radius:25px; min-width:auto !important; color:#ffffff;">
																													<multiline>
																														<a href="{{ env("URL_TIENDA")."login?code=".$user->uniqd }}" target="_blank" class="link c-white" style="display: block; padding: 15px 35px; text-decoration:none; color:#ffffff;">
																															<span class="link c-white" style="text-decoration:none; color:#ffffff;">Verificar ahora</span>
																														</a>
																													</multiline>
																												</td>
																											</tr>
															...
															<table width="100%" border="0" cellspacing="0" cellpadding="0">
																		...
																		<!-- <table border="0" cellspacing="0" cellpadding="0">
																			<tr>
																				<td class="img" width="34" style="font-size:0pt; line-height:0pt; text-align:left;">
																					<a href="#" target="_blank"><img src="../images/ico_facebook.png" width="34" height="34" editable="true" border="0" alt="Facebook" /></a>
																				</td>
																				<td class="img" width="15" style="font-size:0pt; line-height:0pt; text-align:left;"></td>
																				<td class="img" width="34" style="font-size:0pt; line-height:0pt; text-align:left;">
																					<a href="#" target="_blank"><img src="../images/ico_instagram.png" width="34" height="34" editable="true" border="0" alt="Instagram" /></a>
																				</td>
																				<td class="img" width="15" style="font-size:0pt; line-height:0pt; text-align:left;"></td>
																				<td class="img" width="34" style="font-size:0pt; line-height:0pt; text-align:left;">
																					<a href="#" target="_blank"><img src="../images/ico_twitter.png" width="34" height="34" editable="true" border="0" alt="Twitter" /></a>
																				</td>
																				<td class="img" width="15" style="font-size:0pt; line-height:0pt; text-align:left;"></td>
																				<td class="img" width="34" style="font-size:0pt; line-height:0pt; text-align:left;">
																					<a href="#" target="_blank"><img src="../images/ico_pinterest.png" width="34" height="34" editable="true" border="0" alt="Pinterest" /></a>
																				</td>
																			</tr>
																		</table> -->
																		<!-- END Socials -->
																...
																<tr>
																	<td class="text-14 lh-24 a-center c-white l-white pb-20" style="font-size:14px; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 24px; text-align:center; color:#ffffff; padding-bottom: 20px;">
																		<multiline>
																			Calle Ejemplo 12, Ciudad, Estado, País
																			<br />
																		...
																		<table border="0" cellspacing="0" cellpadding="0">
																			<tr>
																				<td class="img" width="117" style="font-size:0pt; line-height:0pt; text-align:left;">
																					<a href="#" target="_blank"><img src="../images/btn_appstore.png" width="117" height="40" editable="true" border="0" alt="App Store" /></a>
																				</td>
																				<td class="img" width="15" style="font-size:0pt; line-height:0pt; text-align:left;"></td>
																				<td class="img" width="117" style="font-size:0pt; line-height:0pt; text-align:left;">
																					<a href="#" target="_blank"><img src="../images/btn_gplay.png" width="117" height="40" editable="true" border="0" alt="Google Play" /></a>
																				</td>
																			</tr>
																		</table>
											...
											<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td class="text-12 lh-22 a-center c-grey- l-grey py-20" style="font-size:12px; color:#6e6e6e; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 22px; text-align:center; padding-top: 20px; padding-bottom: 20px;">
															<unsubscribe class="link c-grey" style="text-decoration:none; color:#6e6e6e;"><span class="link c-grey" style="white-space: nowrap; text-decoration:none; color:#6e6e6e;">Darse de baja</span></unsubscribe> &nbsp;|&nbsp; <webversion class="link c-grey" style="text-decoration:none; color:#6e6e6e;"><span class="link c-grey" style="white-space: nowrap; text-decoration:none; color:#6e6e6e;">Versión web</span></webversion> &nbsp;|&nbsp; <forwardtoafriend class="link c-grey" style="text-decoration:none; color:#6e6e6e;"><span class="link c-grey" style="white-space: nowrap; text-decoration:none; color:#6e6e6e;">Enviar a un amigo</span></forwardtoafriend>
														</td>
													</tr>
												</table>											<!-- END Bottom -->
										</td>
